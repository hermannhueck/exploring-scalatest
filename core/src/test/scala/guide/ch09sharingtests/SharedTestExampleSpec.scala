...
trait StackBehaviors { this: flatspec.AnyFlatSpec =>
...
class SharedTestExampleSpec extends flatspec.AnyFlatSpec with StackBehaviors {
  ...
  "A Stack (with one item less than capacity)" should behave like nonEmptyStack(
